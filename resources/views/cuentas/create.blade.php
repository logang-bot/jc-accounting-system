    ...
    <form action="{{ $modo === 'editar' ? route('cuentas.update', $cuenta->id_cuenta) : route('cuentas.store') }}"
        ...
        <div class="mb-4">
            <label class="inline-flex items-center">
                <input type="checkbox" name="es_movimiento" value="1" id="es_movimiento"
        ...
        <div>
            ...
            <button type="button" class="bg-gray-100 hover:bg-gray-200 text-black font-semibold px-4 py-2 rounde"
                data-hs-overlay="#{{ $modo === 'editar' ? 'edit-cuenta-modal-' . $cuenta->id_cuenta : 'create-cuenta-modal' }}">Cancelar</button>
        </div>
    </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function validarMonedaPrincipal() {
